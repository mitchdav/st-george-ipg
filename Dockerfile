...
RUN apt-get update -y && \
    apt-get install -y software-properties-common python-software-properties swig gcc wget unzip tar
RUN LANG=C.UTF-8 add-apt-repository -y ppa:ondrej/php
RUN apt-get update -y && \
    apt-get install -y php5.6 php5.6-cli php5.6-common php5.6-mbstring php5.6-gd php5.6-intl php5.6-xml php5.6-mcrypt php5.6-zip php5.6-dev php5.6-xdebug php5.6-curl composer
...
RUN wget https://www.ipg.stgeorge.com.au/downloads/StGeorgeLinuxAPI-${IPG_VERSION}.tar.gz -O extension.tar.gz
